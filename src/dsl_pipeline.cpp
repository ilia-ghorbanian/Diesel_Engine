...
namespace dsl
{
    ...
    DslPipeline::~DslPipeline() {
        vkDestroyShaderModule(dslDevice.device(), vertShaderModule, nullptr);
        vkDestroyShaderModule(dslDevice.device(), fragShaderModule, nullptr);
        vkDestroyPipeline(dslDevice.device(), graphicsPipeline, nullptr);
    }
    ...
    void DslPipeline::createGraphicsPipeline(const std::string &vertFilepath, const std::string &fragFilepath, const PipelineConfigInfo &configInfo){
        ...
        auto bindingDescriptions = DslModel::Vertex::getBindingDescriptions();
        auto attributeDescriptions = DslModel::Vertex::getAttributeDescriptions();
    ...
    void DslPipeline::bind(VkCommandBuffer commandBuffer){
    ...
    void DslPipeline::defaultPipelineConfigInfo(PipelineConfigInfo& configInfo){
